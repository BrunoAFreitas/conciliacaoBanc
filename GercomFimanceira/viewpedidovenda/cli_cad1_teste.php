 ...
 *
 */
include_once ("../GercomFimanceira/view/consultaDom.class.php");
include_once ("../GercomFimanceira/view/AtvEconomica.class.php");
		...
		<script type="text/javascript">
			...
			function habilita() {
				...
				var variaveisAl = ["nOrgaoEm", "nDtEm", "edtOrgEm", "edtDtEm", "nSexo", "nNascimento", "selSex", "edtDtNasc", 
								   ...
								   "edtUf", "selTipoDoc", "nUf", "nTipoDoc", "nPdoc", "selPaisDoc", "selPex", "nPoEx", "tabela8"];
				if (obj == 0) {
					//fisica
							...
							<table border="0">
								<tbody>
									...
									<tr>
										...
										<td>
										<?php
											//<input name="edtUf" id="edtUf" type="text" class="campo">	
											echo $dom -> dominio('39', 'edtUf', "id=\"edtUf\" class=\"select\" ");
										?>										
										</td>										
									</tr>
									<tr>
									...
									<tr>
										<td>
											<?php
												...
												//</select>
												echo $dom -> dominio('22', 'selPaisDoc', "id=\"selPaisDoc\" class=\"select\"");
											?>
										</td>
									</tr>
								</tbody>
						...
						<fieldset>
							...
							<table border="0">
								<tbody>
									...
									<tr>
										 ...
										 * </select>
										 */
										 echo $dom -> dominio('23', 'selPex', "id=\"selPex\" class=\"select\"");
										...
										<?php
										  ...
										  */
										  ...
										  echo $dom -> dominio('27', 'selSex', "id=\"selSex\" class=\"select\"");
										?>
										</td>
								...
								<tbody>
									...
									<tr>
										<td>
									        ...
									        echo $dom -> dominio('22', 'selNacio', "id=\"selNacio\" class=\"select\" onChange=\"natural();\"");
											?>
										</td>
										<td id="testTab" >
										...
										<td>		
										<?php
											//<input name="edtUfEnd" id="edtUfEnd" type="text" class="campo">	 
										    echo $dom -> dominio('39', 'edtUfEnd', "id=\"edtUfEnd\" class=\"select\" ");//sem get set	
									    ?>
										</td>
								...
								<tbody>
									...
									<tr>
										...
										<?php
											 ...
											 *</select>
											 */
										echo $dom -> dominio('07', 'selEstCiv', "id=\"selEstCiv\" class=\"select\" ");//novo padrão da class de dominio.
										?>a
										</td>
								...
								<tbody>
									...
									<tr>
										...
										<?php
											...
											//	? >
											//</select>
										echo $dom -> dominio('37', 'edtTipRes', "id=\"edtTipRes\" class=\"select1\" ");
										?>
										</td>
							...
							<table border="0" id="tabela8">
								<tbody>
									...
									<tr>
										<td>
											<?php
											//<select name="selTipoRes" id="selTipoRes" class="select1">
											//</select>
											echo $dom -> dominio('37', 'selTipoRes', "id=\"selTipoRes\" class=\"select1\" ");
											?>
										</td>
										<td>
											...
											//</select>
											echo $dom -> dominio('05', 'selEndCore', "id=\"selEndCore\" class=\"select1\" ");
											?>
										</td>
									</tr>
								</tbody>	
							...
							<table border="0" id="tabela9">
								<tbody>
									...
									<tr>
										<td><input name="edtDesde" id="edtDesde" type="text" class="campo"></td>
										<td>
											<?php
											//<select name="selSede" id="selSede" class="select1">
											//</select>
											echo $dom -> dominio('26', 'selSede', "id=\"selSede\" class=\"select1\" ");
											?>
										</td>
										<td><input name="edtDataAtiv" id="edtDataAtiv" type="text" class="campo"></td>
									</tr>
								</tbody>
							</table>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											//</select>
											echo $dom -> dominio('21', 'selOcupacao', "id=\"selOcupacao\" class=\"select1\" ");
											?>
										</td>
									</tr>
								</tbody>
								...
								<tbody>
									...
									<tr>
										<td>
											...
											//</select>
											echo $dom -> dominio('12', 'selGruAtEco', "id=\"selGruAtEco\" class=\"select1\" ");
											?>
										</td>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											//</select>
											echo $atv -> atvEconomica('01', 'selAtEco', "id=\"selAtEco\" class=\"select1\"" );
											?>
										</td>
