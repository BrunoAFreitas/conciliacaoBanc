...
// passo 1
include_once("../model/criarProposta.php");
// passo 2
include_once("../model/criarInterveniente.php");
// passo 3
include_once("../model/associarEnderecoInterveniente.php");
// passo 4
include_once("../model/associaReferencia.php");
// passo 5
include_once("../model/associaGarantia.php");
// passo 6
include_once("../model/consolidarProposta.php");
//classe Adicional
