<?php
	...
	/**
	 * CASO O CAIXA ESTEJA TRAVADO MOSTRAR OUTRA TELA 
	 * COM A MENSAGEM INDICANDO QUE O CAIXA ESTA TRAVADO
	 * CASO NAO ESTEJA MOSTRAR A TELA NORMAL
	 */
...
<?
			...
			////////////////////////////////////////////////////////////////
			///////////ESTA E A PRIMEIRA E MAIOR CONDIÇÃO DA PAGINA/////////
			////////////////////////////////////////////////////////////////
			...
			ped_alterado = 'S', ped_dtalterado = '$data', ped_hora = '$hora', ped_login =
			'$acelogin'
			WHERE ped_num = '$edtNumPed' AND ped_loja = '$ljcod';";
			...
			////////////////////////////////////////////////////////////////
			////////////////ESTA E A SEGUNDA CONDIÇÃO DA PAGINA//////////////
			////////////////////////////////////////////////////////////////
			if($flag == "finalizar") {
			$data = muda_data_en($data);
			...
			////////////////////////////////////////////////////////////////
			////////////////ESTA E A ULTIMA CONDIÇÃO DA PAGINA//////////////
			////////////////////////////////////////////////////////////////
			if($incluir_prod == "s") {
			...
			// echo $descontomax.'$descontomax'; echo $edtValunit.'$edtValunit'; echo $Valunit.'$Valunit'; echo
			//$coef.'$coef'; echo $desconto.'$desconto';
			// echo $descontomax.'$descontomax'; 		echo $edtValunit.'$edtValunit';
			////////////////////////////////////////////////////////////////
			//ESTA E CONDIÇÃO TB E GRANDE E FECHA JUNTO COM A ULTIMA CONDIÇÃO//
			...
			WHERE sal_cod = '$edtProd' AND sal_cor = '$lstCor' AND sal_progrupo =
			'$lstProg'
			...
			AND pm_cor = '$lstCor' AND pm_escala = '$lstEscala' AND pm_progrupo
			= '$lstProg'
			AND pm_emp = '$codemp' AND pm_loja = '$lstLoja'
			AND pm_es = 'S';";
			$query_checa = mysql_query($sql_checa,$conexao)or die("Erro na Veririfcação do
			Item");
			...
			pm_entregue,pm_comissao,pm_estoqueok,pm_promocao,pm_hora, pm_login,
			pm_fab)
			VALUES ('$edtNumPed', '$edtProd','$codemp', '$lstLoja',
			'$ljcod', '$lstCor','$lstEscala','$lstProg','S',
			...
			if ($edtNomeprod != "Produto não encontrado"){
			if (($edtqtd == "") || ($edtqtd == "0") || ($edtProd == "")){
			$msg_prod = "Não foi escolhido quantidade para este produto e ele não
			será inserido!";
			}else{
			include("atualiza_pmfab.php");
			$sql_incl   = "INSERT INTO pedmov
